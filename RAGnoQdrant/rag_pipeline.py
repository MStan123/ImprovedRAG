...
"""
        ...
        if is_casual:
            messages = [{
                ...
                "content": (
                    ...
                    f"Be ready to answer ONLY in Russian, Azerbaijani — whichever the user chooses.\n"
                    f"Be warm and brief."
                )
            }, {
                "role": "user",
    ...
    if intent == "KNOWLEDGE_BASE":
        ...
        # 6. КЭШИРОВАНИЕ УБРАНО - теперь всегда идём в LLM
        from_cache = False  # ✅ ИНИЦИАЛИЗАЦИЯ
